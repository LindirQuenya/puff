import { extract_float, extract_impedance, extract_length, TLINE_LABEL } from "./regex";
import { Impedance, Length, LengthUnit, TLine } from "./types";
...
export function parse_tline(s: string): TLine | null {
	...
	const correction = extract_length(s, startInd, true) ?? [{value: 0, units: LengthUnit.Degrees}, 0];
